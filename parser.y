...
Hashtable<Decl*> *global_scope = new Hashtable<Decl*>;  //global scope
Hashtable< Hashtable<Decl*>* > *class_scopes = new Hashtable <Hashtable<Decl*>* >; 
Hashtable< Hashtable<Decl*>* > *interface_scopes = new Hashtable <Hashtable<Decl*>* >; 
...
Program   :    DeclList            { 
                                      ...
                                      // if no errors, advance to next phase
                                         ...
                                         if (ReportError::NumErrors() == 0) {
                                          program->Check(class_scopes, interface_scopes, false);
                                           program->Check(class_scopes, interface_scopes, true);
                                          program->Emit(); 
                                           }
